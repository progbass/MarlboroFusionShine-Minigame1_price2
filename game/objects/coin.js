Coin = function (game, _slot, _x, _y, _frame) {
	...
	this.label.fontSize = '64pt';
	this.label2 = this.addChild( new Phaser.Text(this.game, 0, 45, '', this.game.font_style) );
	this.label2.anchor.setTo(.5, .5);
	this.label2.fill = '#ffffff';
	this.label2.fontSize = '13pt';
	this.yvel = 0;
	this.xvel = 0;
...
Coin.prototype.setupFrame = function(_label) {
	...
	switch(this.frame){
		case 0:
			var precios = [{tint: 0xff0000, label: '$42'}, {tint: 0x00ff00, label: '$61'}, {tint: 0x0000ff, label: '$55'}, {tint: 0xff00ff, label: '$38'}];
			...
			//
			this.body.setSize(this.width - 75, this.height - 60, 40, 47);

			break;

		case 1:
			this.scale.setTo(.9, .9);
			this.body.setSize(170, 120, 5, 35);
			break;

		case 2:
			this.body.setSize(170, 150, 5, 20);
			break;

		case 3:
			this.scale.setTo(.9, .9);
			this.body.setSize(175, 93, 5, 48);
			break;

		case 4:
			this.body.setSize(165, 80, 5, 50);
			break;

		case 5:
			this.body.setSize(this.width - 30, this.height - 80, 14, 40);
			break;

		case 6:
			this.body.setSize(this.width - 15, this.height - 110, 5, 60);
			break;
